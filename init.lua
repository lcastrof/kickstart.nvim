...
-- Delete with 'd' command and don't save it to a register
vim.keymap.set({ 'n', 'v' }, 'd', '"_d')

-- Delete with 'c' command and don't save it to a register
vim.keymap.set({ 'n', 'v' }, 'c', '"_c')

-- Comment like VSCode
vim.keymap.set({ 'n', 'v' }, '<C-/>', 'gcc<Esc>', { remap = true, desc = 'Comment line/selection' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Search through all files, including inside .gitignore
      vim.keymap.set(
        'n',
        '<leader>sa', -- 'sa' de Search All
        function()
          builtin.live_grep {
            additional_args = function() return { '--no-ignore', '--hidden' } end,
            prompt_title = 'Live Grep (Incluindo Ignorados)',
          }
        end,
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      local parsers =
        { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'go', 'javascript', 'typescript' }
